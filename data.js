...
function setData(){
    ...
    insertDB(systemDB,
        ...
        insertDB(systemDB,
            ...
            ,"https://movie-phinf.pstatic.net/20171222_56/1513906341368blx3Q_JPEG/movie_image.jpg","#732f6a","#543e53","#6da0d5","#1c296f","#e48780","https://youtu.be/LmS5KMJTWlA");
            insertDB(systemDB,
            ...
            insertDB(systemDB,
                "리틀 포레스트","2014","드라마","모리 준이치","하시모토 아이|마츠오카 마유|누쿠미즈 요이치|키리시마 카렌|미우라 타카히로|","https://movie-phinf.pstatic.net/20150114_206/1421200132061BpI2D_JPEG/movie_image.jpg","#d2a02d","#be8b5e","#e3be39","#e6c23a","#d3c62c","https://youtu.be/IWpBGln6bNk");
            insertDB(systemDB,
            "돈","2019","범죄","박누리","류준열|유지태|조우진","https://movie-phinf.pstatic.net/20190306_280/1551849045570X4iac_JPEG/movie_image.jpg?type=m665_443_2","#94b27c","#b3c2ad","#54623e","#265221","#153408","https://youtu.be/dbCoJpk7_dA");
            insertDB(systemDB,
            ...
            insertDB(systemDB,
            "데드풀","2016","액션","팀 밀러","라이언 레이놀즈","https://movie-phinf.pstatic.net/20160219_61/1455872433882gKqgb_JPEG/movie_image.jpg","#972a3d","#000002","#a22640","#3c3b49","#94939a","https://youtu.be/AubJhjH0MfY");
            insertDB(systemDB,
            ...
            insertDB(systemDB,
            "인턴","2015","코미디","낸시 마이어스","로버트 드 니로|앤 해서웨이|","https://movie-phinf.pstatic.net/20150910_279/1441866003899BJKw7_JPEG/movie_image.jpg","#5c0108","#968976","#001231","#1d436a","#960818","https://youtu.be/bwylOLy5ir0");
            insertDB(systemDB,
            "업","2009","애니메이션|가족|모험|코미디|액션","피트 닥터|밥 피터슨","에드워드 애스너| 조던 나가이| 크리스토퍼 플러머| 밥 피터슨","https://movie-phinf.pstatic.net/20111223_221/1324590426566npnJd_JPEG/movie_image.jpg?type=m665_443_2","#458bc7","#7fa7cb","#ececec","#aa9faa","#65a1d5","https://youtu.be/551YG0kBQks");
            insertDB(systemDB,
            "주먹왕 랄프","2012","애니메이션|코미디|가족","리치 무어","제인 린치| 존 C. 레일리| 잭 맥브레이어| 정준하","https://movie-phinf.pstatic.net/20121123_34/1353646026595Ju6dI_JPEG/movie_image.jpg?type=m665_443_2","#cf4636","#b36b9b","#0f2557","#b94165","#93d5f5","https://youtu.be/wErk0gZpq38");
            insertDB(systemDB,
            "토이 스토리4","2019","애니메이션/모험/코미디/가족/판타지","조시 쿨리","톰 행크스|팀 알렌|애니 파츠|토니 헤일","https://movie-phinf.pstatic.net/20190611_117/1560221190708y3bbv_JPEG/movie_image.jpg?type=m665_443_2","#cbd8e1","#4883bb","#c8b733","#393f59","#000002","https://youtu.be/u8GQibRXVHg");
            insertDB(systemDB,
            "인사이드 아웃","2015","애니메이션/코미디","피트 닥터","에이미 포엘러|필리스 스미스|민디 캘링|빌 헤이더|루이스 블랙|케이틀린 디아스|카일 맥라클란|다이안 레인|","https://movie-phinf.pstatic.net/20150714_216/14368354197498c2rS_JPEG/movie_image.jpg?type=m665_443_2","#f9b842","#7a1863","#00a64e","#040241","#05004b","https://youtu.be/1KGZtWbZtq8");
            insertDB(systemDB,
            "주토피아","2016","애니메이션/액션/모험/코미디/가족","바이론 하워드, 리치무어","지니퍼 굿윈|제이슨 베이트먼|알란 터딕|이드리스 엘바|J.K. 시몬스","https://movie-phinf.pstatic.net/20160217_153/1455686083975zjajH_JPEG/movie_image.jpg?type=m665_443_2","#ebffff","#e5c094","#82d6fa","#7474a6","#2a171d","https://www.youtube.com/watch?v=RGucZx3TUnc");
            insertDB(systemDB,
